...
curl 'https://data.chhs.ca.gov/api/3/action/datastore_search_sql?sql=SELECT%20*%20FROM%20%28SELECT%20date,area,population,cumulative_total_tests,cumulative_positive_tests,cumulative_cases,cumulative_deaths,RANK%28%29%20OVER%20%28PARTITION%20BY%20area%20ORDER%20BY%20date%20DESC%29%20area_rank%20FROM%20%22046cdd2b-31e5-4d34-9ed3-b48cdbc4be7a%22%20WHERE%20date%20IS%20NOT%20NULL%29%20p%20WHERE%20p.area_rank%20=%201' > dashboard.json
