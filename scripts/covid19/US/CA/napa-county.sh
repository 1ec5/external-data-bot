...
curl -X POST -d 'sheet_id=Daily%20Summary' https://public.tableau.com/vizql/w/LandingPage_16292272663630/v/DailySummary/bootstrapSession/sessions/${SESSIONID} | sed -E 's/^[0-9]+;//' > dashboard.json
