...
curl 'https://data.sccgov.org/resource/tg4j-23y2.json' | jq 'map(.date = (.date | split("T")[0]) | {date: (.date | sub("^2012"; "2021") | sub("^2021-12-31"; "2021-01-13")), deaths: (.cumulative | tonumber)})' > deaths.json
