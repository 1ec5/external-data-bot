...
curl 'https://data.sccgov.org/resource/tg4j-23y2.json' | jq 'map(.date = (.date | split("T")[0]) | {date: (.date | sub("^2012"; "2021") | sub("^1921-01-19"; "2021-01-19")), deaths: (.cumulative | tonumber)})' > deaths.json
