...
curl 'https://gis.nola.gov/arcgis/rest/services/apps/LDH_Data/MapServer/0/query?where=1%3D1&outFields=Date%2CNO_Cases%2CNO_Deaths&returnGeometry=false&f=json' > table.json
